...
> Applies To: All `.sh` files in astronomy-rag-corpus  
...
local data_path="/mnt/astro_corpus"
export CORPUS_ROOT="/mnt/astro_corpus"
```
...
#!/usr/bin/env bash
# =============================================================================
# Script Name  : check-corpus-sizes.sh
# Description  : Reports disk usage for corpus directories
# Repository   : astronomy-rag-corpus
# Author       : VintageDon (https://github.com/vintagedon)
# ORCID        : 0009-0008-7695-4093
# Created      : 2025-12-29
...
#
# DESCRIPTION
#   Calculates and displays disk usage statistics for the PDF/LaTeX artifacts
#   and processed text directories on the SMB share. Useful for monitoring
#   corpus growth and storage consumption.
#
# USAGE
#   ./check-corpus-sizes.sh
#
# EXAMPLES
#   ./check-corpus-sizes.sh
#       Prints human-readable sizes for corpus directories.
#
# =============================================================================
...
ARTIFACTS_PATH="/mnt/astro_corpus/artifacts"
PROCESSED_PATH="/mnt/astro_corpus/processed"
...
main() {
    ...
    echo "Processed Text:"
    du -sh "${PROCESSED_PATH}"

    echo "Paper count:"
    find "${ARTIFACTS_PATH}" -name "*.pdf" | wc -l
}
